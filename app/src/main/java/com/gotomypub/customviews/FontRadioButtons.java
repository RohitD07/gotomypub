...
public class FontRadioButtons extends AppCompatRadioButton {
    public FontRadioButtons(Context context) {
        super(context);
        applyCustomFont(context,null);

    }

    public FontRadioButtons(Context context, AttributeSet attrs) {
        super(context, attrs);
        applyCustomFont(context,attrs);
    }

    public FontRadioButtons(Context context, AttributeSet attrs, int defStyleAttr) {
